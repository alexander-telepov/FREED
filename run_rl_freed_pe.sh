...
CUDA_LAUNCH_BLOCKING=1 python run_rl.py --name='pocket0_denovo_per' \
                       ...
                       --seed=141 --intr_rew=0 --intr_rew_ratio=5e-1 --target='usp7' \
                       --update_after=2000 --start_steps=3000 --update_every=256 --init_alpha=1.0 \
                       --desc='ecfp' \
                       --rl_model='sac' \
                       --active_learning='freed_pe' \
                       --gpu_id=1 --emb_size=64 --tau=1e-1 --batch_size=128 --target_entropy=0.05 > /mnt/2tb/experiments/freed/logs/logs_crem/pocket0_denovo_per.txt